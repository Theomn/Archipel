 Shader "Sprites/Isometric"
 {
     Properties
     {
         ...
         _ViewAngle ("Camera View Angle", Float) = 0
         ...
         Pass
         {
             ...
             #include "UnityCG.cginc"
                 ...
                 UNITY_INSTANCING_BUFFER_START(PerDrawSprite)
                     // SpriteRenderer.Color w$$anonymous$$le Non-Batched/Instanced.
                     UNITY_DEFINE_INSTANCED_PROP(fixed4, unity_SpriteRendererColorArray)
                     // t$$anonymous$$s could be smaller but that's how bit each entry is regardless of type
